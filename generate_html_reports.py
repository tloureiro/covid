...
def get_places():
    ...
    places = {
        ...
        'Quebec': df[(df['subregion1_name'] == 'Quebec')],
        ...
        'Uruguay': df[(df['country_name'] == 'Uruguay') & (df['aggregation_level'] == 0)],
        'Sweden': df[(df['country_name'] == 'Sweden') & (df['aggregation_level'] == 0)],
        'Netherlands': df[(df['country_name'] == 'Netherlands') & (df['aggregation_level'] == 0)],
        ...
        'India': df[(df['country_name'] == 'India') & (df['aggregation_level'] == 0)],
    }
